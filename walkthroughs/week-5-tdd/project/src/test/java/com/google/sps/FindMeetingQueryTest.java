...
public final class FindMeetingQueryTest {
  ...
  private static final int TIME_0400AM = TimeRange.getTimeInMinutes(4, 0);
  ...
  private static final int TIME_0800PM = TimeRange.getTimeInMinutes(20, 0);
  ...
  // Test cases for optional guests
  @Test
  public void everyAttendeeIsConsideredOptionalNotConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalIsConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredOnlyOptional() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  @Test
  public void everyAttendeeIsConsideredSubsetOfOptionalIsConsidered() {
    // Have each person have different events. We should see two options because each person has
    // split the restricted times.
    //
    // Events  :       |--A--|     |--B--|
  ...
  public void mostOptionalEventsInALine() {
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TimeRange.START_OF_DAY, DURATION_4_HOUR),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0400AM, DURATION_4_HOUR),
            Arrays.asList(PERSON_B)),
        new Event("Event 3", TimeRange.fromStartDuration(TIME_0800AM, DURATION_4_HOUR),
            Arrays.asList(PERSON_C)),
        new Event("Event 4", TimeRange.fromStartDuration(TIME_1200PM, DURATION_4_HOUR),
            Arrays.asList(PERSON_D)),
        new Event("Event 3", TimeRange.fromStartDuration(TIME_0400PM, DURATION_4_HOUR),
            Arrays.asList(PERSON_E)),
        new Event("Event 4", TimeRange.fromStartDuration(TIME_0800PM, DURATION_4_HOUR),
